    ...
    if lab_id == "lab-45-secure-copy":
        return _replace_lab_progression(
            ...
            [
                ...
                [
                    "scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -o IdentitiesOnly=yes -i /root/.ssh/rhcsa_vagrant_ed25519 /root/rhcsa10-transfer.txt root@server:/root/rhcsa10-transfer.txt",
                    "ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -o IdentitiesOnly=yes -i /root/.ssh/rhcsa_vagrant_ed25519 root@server 'cat /root/rhcsa10-transfer.txt'",
                ],
            ],
            points=[10, 20],
        )
