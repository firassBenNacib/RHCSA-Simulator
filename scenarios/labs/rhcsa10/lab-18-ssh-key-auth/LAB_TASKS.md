...
Create user key10 and set password cinder9.

---

## Task 02 - Create /home/key10/.ssh/authorized_keys with the provided public key tex (client) - 10 pts

Create /home/key10/.ssh/authorized_keys with the provided public key text ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIRhcsa10keydemo rhcsa10.

---

## Task 03 - Set secure ownership and permissions on the SSH directory and authorized (client) - 10 pts

Set secure ownership and permissions on the SSH directory and authorized_keys file.
