...
On client, create user ferro if it does not exist and set its password to cinder9.

---

## Task 02 - Configure a cron job for ferro that runs every 2 (client) - 10 pts

On client, configure a cron job for ferro that runs every 2 minutes and logs the message "Lab 07 running" with logger.
