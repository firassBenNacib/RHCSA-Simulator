...
On client, create an executable script /usr/local/bin/listlogs31 that loops over the files in /opt/lab31 and writes the absolute path of each file ending in .log to /root/listlogs31.out.

---

## Task 02 - Run the script once (client) - 10 pts

On client, run the script once.
